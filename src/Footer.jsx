...
function Footer() {
    return (
        <div className='w-full h-screen p-20 flex gap-10 font-["Neue_Montreal"] overflow-hidden bg-zinc-200'>
            <div className="w-1/2 h-full flex flex-col justify-between ">

                <div className='heading'>
                    <h1 className='text-[6vw]  font-semibold uppercase leadeing-none -mb-10'>Eye-</h1>
                    <h1 className='text-[6vw]  font-semibold uppercase leadeing-none -mb-10'>Opening</h1>
                </div>
            ...
            <div className="w-1/2">
                <div className='heading'>
                    <h1 className='text-[6vw]  font-semibold uppercase leadeing-none -mb-10'>Presentations</h1>
                </div>
                <div className='dets mt-10'>
                        {["Facebook","Instagram","Twitter"].map((item,index)=>(<a className='block text-2xl' href='#' key={index}>{item}</a>))}
                    </div>
            </div>
        </div>
    )
